...
setTimeout(() => {a({body: "𝗛𝗶 𝗧𝗮𝗻𝘃𝗶𝗿 er জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "𝗛𝗶 𝗧𝗮𝗻𝘃𝗶𝗿 er জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
